...
class STARKVINDAirpurifier extends DeviceTest {
    final static String JSON = """
            {
              "id" : "XXXXXXXXXXXXXXXXXXX",
              "type" : "airPurifier",
              "deviceType" : "airPurifier",
              "createdAt" : "2022-11-05T22:40:42.000Z",
              "isReachable" : true,
              "lastSeen" : "2022-11-16T17:46:45.000Z",
              "attributes" : {
                "customName" : "Luftrenare hall",
              ...
              "room" : {
                "id" : "a7301b11-95f6-4ee3-a764-22d4ea52d161",
                "name" : "Hall",
    ...
    public STARKVINDAirpurifier() {
        super(JSON);
    }

    @Override
    public void validateDeserialize(final Device<?,?> device) {
        assertTrue(device instanceof AirPurifierDevice);
    }
}
...
@Component
public class DirigeraClientDeviceApi extends AbstractApi {
    private final static Logger log = LoggerFactory.getLogger(DirigeraClientDeviceApi.class);

    public DirigeraClientDeviceApi(

...
import de.dvdgeisler.iot.dirigera.client.api.http.rest.json.scene.SceneInfo;
import de.dvdgeisler.iot.dirigera.client.api.http.rest.json.scene.SceneTrigger;

...
public class LightStateCommand extends DeviceStateCommand<LightStateAttributes> {
    ...
    public final static LightStateCommand LIGHT_COLOR_RED = new LightStateCommand(null, null, new LightStateAttributes(null, null, null, COLOR_RED));
    public final static LightStateCommand LIGHT_COLOR_GREEN = new LightStateCommand(null, null, new LightStateAttributes(null, null, null, COLOR_GREEN));
    public final static LightStateCommand LIGHT_COLOR_BLUE = new LightStateCommand(null, null, new LightStateAttributes(null, null, null, COLOR_BLUE));
    public final static LightStateCommand LIGHT_COLOR_WHITE = new LightStateCommand(null, null, new LightStateAttributes(null, null, null, COLOR_WHITE));
    public final static LightStateCommand LIGHT_TEMPERATURE_2000 = new LightStateCommand(null, null, new LightStateAttributes(null, null, null, COLOR_TEMPERATURE_2000));
    public final static LightStateCommand LIGHT_TEMPERATURE_2500 = new LightStateCommand(null, null, new LightStateAttributes(null, null, null, COLOR_TEMPERATURE_2500));
    public final static LightStateCommand LIGHT_TEMPERATURE_3000 = new LightStateCommand(null, null, new LightStateAttributes(null, null, null, COLOR_TEMPERATURE_3000));
    public final static LightStateCommand LIGHT_TEMPERATURE_3500 = new LightStateCommand(null, null, new LightStateAttributes(null, null, null, COLOR_TEMPERATURE_3500));
    public final static LightStateCommand LIGHT_TEMPERATURE_4000 = new LightStateCommand(null, null, new LightStateAttributes(null, null, null, COLOR_TEMPERATURE_4000));

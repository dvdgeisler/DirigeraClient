...
@Component
public class DirigeraClientSceneApi extends AbstractApi {
    private final static Logger log = LoggerFactory.getLogger(DirigeraClientSceneApi.class);

    public DirigeraClientSceneApi(

...
@Component
public class DirigeraClientOAuthApi extends AbstractApi {
    private final static Logger log = LoggerFactory.getLogger(DirigeraClientOAuthApi.class);
    ...
    public DirigeraClientOAuthApi(
        ...
        this.clientName = Optional
                ...
                .orElseGet(DirigeraClientOAuthApi::defaultClientName);
    ...
    public Mono<Token> refreshToken() {
        ...
        return this.webClient
                ...
                .onStatus(HttpStatus::isError, this::onError)
                .bodyToMono(Token.class)
                .doOnSuccess(DirigeraClientOAuthApi.this.tokenStore::setAccessToken);
    }
    ...
    public Mono<Token> pair() {
        ...
        codeVerifier = DirigeraClientOAuthApi.generateCodeVerifier();
        codeChallenge = DirigeraClientOAuthApi.calculateCodeChallenge(codeVerifier);

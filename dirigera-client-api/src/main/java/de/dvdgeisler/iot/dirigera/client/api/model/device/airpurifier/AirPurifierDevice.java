...
public class AirPurifierDevice extends Device<AirPurifierAttributes, AirPurifierConfigurationAttributes> {
    ...
    public AirPurifierDevice(final String id, final LocalDateTime createdAt, final Boolean isReachable, final LocalDateTime lastSeen, final AirPurifierAttributes attributes, final DeviceCapabilities capabilities, final List<String> remoteLinks, final AirPurifierConfigurationAttributes outletConfigurationAttributes) {
        super(id, DeviceCategory.AIR_PURIFIER, DeviceType.AIR_PURIFIER, createdAt, isReachable, lastSeen, attributes, capabilities, remoteLinks, outletConfigurationAttributes);
    }

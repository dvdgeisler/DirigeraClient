...
@Component
public class RestRemoteLinkApi extends AbstractRestApi {
    private final static Logger log = LoggerFactory.getLogger(RestRemoteLinkApi.class);

    private final RestOAuthApi oauth;

    public RestRemoteLinkApi(

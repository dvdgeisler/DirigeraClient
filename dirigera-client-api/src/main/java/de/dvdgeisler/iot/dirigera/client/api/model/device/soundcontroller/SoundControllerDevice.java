...
public class SoundControllerDevice extends Device<SoundControllerAttributes, SoundControllerConfigurationAttributes> {
    ...
    public SoundControllerDevice(final String id, final LocalDateTime createdAt, final Boolean isReachable, final LocalDateTime lastSeen, final SoundControllerAttributes attributes, final DeviceCapabilities capabilities, final List<DeviceSet> deviceSet, final List<String> remoteLinks, final SoundControllerConfigurationAttributes soundControllerConfigurationAttributes) {
        super(id, CONTROLLER, SOUND_CONTROLLER, createdAt, isReachable, lastSeen, attributes, capabilities, deviceSet, remoteLinks, soundControllerConfigurationAttributes);
    }

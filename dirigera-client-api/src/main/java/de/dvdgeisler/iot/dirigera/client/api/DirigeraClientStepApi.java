...
@Component
public class DirigeraClientStepApi extends AbstractApi {
    private final static Logger log = LoggerFactory.getLogger(DirigeraClientStepApi.class);

    public DirigeraClientStepApi(

...
public class ShortcutControllerDevice extends Device<ShortcutControllerAttributes, ShortcutControllerConfigurationAttributes> {
    ...
    public ShortcutControllerDevice(final String id, final LocalDateTime createdAt, final Boolean isReachable, final LocalDateTime lastSeen, final ShortcutControllerAttributes attributes, final DeviceCapabilities capabilities, final List<DeviceSet> deviceSet, final List<String> remoteLinks, final ShortcutControllerConfigurationAttributes shortcutControllerConfigurationAttributes) {
        super(id, CONTROLLER, SHORTCUT_CONTROLLER, createdAt, isReachable, lastSeen, attributes, capabilities, deviceSet, remoteLinks, shortcutControllerConfigurationAttributes);
    }

...
public class GatewayDevice extends Device<GatewayAttributes, GatewayConfigurationAttributes> {
    ...
    public GatewayDevice(final String id, final LocalDateTime createdAt, final Boolean isReachable, final LocalDateTime lastSeen, final GatewayAttributes attributes, final DeviceCapabilities capabilities, final List<DeviceSet> deviceSet, final List<String> remoteLinks, final GatewayConfigurationAttributes configurationAttributes) {
        super(id, DeviceCategory.GATEWAY, DeviceType.GATEWAY, createdAt, isReachable, lastSeen, attributes, capabilities, deviceSet, remoteLinks, configurationAttributes);
    }
